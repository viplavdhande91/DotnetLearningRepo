...
using Company.FutureProject.Core.ProjectAggregate;
using Company.FutureProject.Core.Services;
using Company.FutureProject.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace Company.FutureProject.UnitTests.Core.Services
{
